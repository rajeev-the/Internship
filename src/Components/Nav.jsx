  ...
  return (
    ...
    <motion.div  className={nav ? "nav1change" : "nav1" }>
        ...
        >
             ...
             <a className={nav ?  "af": "aa"}  href="#">About</a>
             <a  className={nav ?  "af":"aa"} href="#">Aggregator</a>
             <a className={nav ?  "af":"aa"} href="#">Features</a>
             <a className={nav ?  "af":"aa"} href="#">Roadmap</a>
             <a className={nav ?  "af":"aa"} href="#">Contact us</a>
